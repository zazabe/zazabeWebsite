...
INSERT INTO `article` VALUES (1,1,-1,21,3,4,2),(2,1,-2,21,9,10,2),(3,1,-3,21,7,8,2),(4,1,-4,21,13,14,2),(5,1,-5,21,15,16,2),(6,1,-6,21,17,18,2),(21,1,-7,21,1,20,0),(22,1,-8,21,2,5,1),(23,1,-9,21,6,11,1),(24,1,-10,21,12,19,1);
...
--
-- Table structure for table `article_skill`
--

DROP TABLE IF EXISTS `article_skill`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `article_skill` (
  `article_id` int(11) NOT NULL DEFAULT '0',
  `skill_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`article_id`,`skill_id`),
  KEY `article_skill_skill_id_skill_id` (`skill_id`),
  CONSTRAINT `article_skill_article_id_article_id` FOREIGN KEY (`article_id`) REFERENCES `article` (`id`) ON DELETE CASCADE,
  CONSTRAINT `article_skill_skill_id_skill_id` FOREIGN KEY (`skill_id`) REFERENCES `skill` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `article_skill`
--

LOCK TABLES `article_skill` WRITE;
/*!40000 ALTER TABLE `article_skill` DISABLE KEYS */;
INSERT INTO `article_skill` VALUES (2,1),(3,1),(3,2),(4,2),(5,2);
/*!40000 ALTER TABLE `article_skill` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `dm_auto_seo` VALUES (1,'article','show','2010-08-27 15:20:58','2010-08-27 15:20:58'),(2,'dmTag','show','2010-08-27 15:22:21','2010-08-27 15:22:21'),(3,'skill','show','2010-09-12 17:51:34','2010-09-12 17:51:34');
...
INSERT INTO `dm_auto_seo_translation` VALUES (1,'%article.title%','%article.title%','%article.title%',NULL,'%article.body%',NULL,NULL,'fr'),(2,'%dm_tag.name%','%dm_tag.name%','%dm_tag.name%',NULL,'%dm_tag.name%',NULL,NULL,'fr'),(3,'%skill.name%','%skill.name%','%skill.name%',NULL,'%skill.name%',NULL,NULL,'fr');
...
INSERT INTO `dm_lock` VALUES (80,1,'admin','dmAdmin','index',0,1284454966,'admin','/admin.php','fr');
...
INSERT INTO `dm_page` VALUES (1,'main','root',0,'',1,150,0),(2,'main','error404',0,NULL,4,5,1),(3,'main','signin',0,NULL,2,3,1),(4,'dmTag','list',0,NULL,6,63,1),(5,'article','list',0,NULL,64,85,1),(6,'article','show',1,NULL,65,66,2),(7,'dmTag','show',1,NULL,7,8,2),(8,'dmTag','show',2,NULL,9,10,2),(9,'dmTag','show',3,NULL,11,12,2),(10,'dmTag','show',4,NULL,13,14,2),(11,'dmTag','show',5,NULL,15,16,2),(12,'dmTag','show',6,NULL,17,18,2),(13,'article','show',2,NULL,67,68,2),(14,'dmTag','show',7,NULL,19,20,2),(15,'dmTag','show',8,NULL,21,22,2),(16,'dmTag','show',9,NULL,23,24,2),(17,'article','show',3,NULL,69,70,2),(18,'dmTag','show',10,NULL,25,26,2),(19,'dmTag','show',11,NULL,27,28,2),(20,'article','show',4,NULL,71,72,2),(21,'dmTag','show',12,NULL,29,30,2),(22,'dmTag','show',13,NULL,31,32,2),(23,'article','show',5,NULL,73,74,2),(24,'dmTag','show',14,NULL,33,34,2),(25,'article','show',6,NULL,75,76,2),(26,'main','zazabe',0,NULL,86,87,1),(27,'main','cursus',0,'',88,89,1),(28,'main','projects',0,NULL,90,91,1),(29,'main','about',0,NULL,92,93,1),(44,'article','show',21,NULL,77,78,2),(45,'dmTag','show',15,NULL,35,36,2),(46,'dmTag','show',16,NULL,37,38,2),(47,'dmTag','show',17,NULL,39,40,2),(48,'dmTag','show',18,NULL,41,42,2),(49,'dmTag','show',19,NULL,43,44,2),(50,'dmTag','show',20,NULL,45,46,2),(51,'article','show',22,NULL,79,80,2),(52,'dmTag','show',21,NULL,47,48,2),(53,'article','show',23,NULL,81,82,2),(54,'dmTag','show',22,NULL,49,50,2),(55,'dmTag','show',23,NULL,51,52,2),(56,'dmTag','show',24,NULL,53,54,2),(57,'dmTag','show',25,NULL,55,56,2),(58,'article','show',24,'',83,84,2),(59,'dmTag','show',26,NULL,57,58,2),(60,'dmTag','show',27,NULL,59,60,2),(61,'dmTag','show',28,NULL,61,62,2),(62,'main','cursusPrint',0,'',94,95,1),(63,'main','cursusDownload',0,NULL,96,97,1),(64,'skill','list',0,NULL,98,149,1),(65,'skill','show',1,NULL,99,100,2),(66,'skill','show',2,NULL,101,102,2),(67,'skill','show',3,NULL,103,104,2),(68,'skill','show',4,NULL,105,106,2),(69,'skill','show',5,NULL,107,108,2),(70,'skill','show',6,NULL,109,110,2),(71,'skill','show',7,NULL,111,112,2),(72,'skill','show',8,NULL,113,114,2),(73,'skill','show',9,NULL,115,116,2),(74,'skill','show',10,NULL,117,118,2),(75,'skill','show',11,NULL,119,120,2),(76,'skill','show',12,NULL,121,122,2),(77,'skill','show',13,NULL,123,124,2),(78,'skill','show',14,NULL,125,126,2),(79,'skill','show',15,NULL,127,128,2),(80,'skill','show',16,NULL,129,130,2),(81,'skill','show',17,NULL,131,132,2),(82,'skill','show',18,NULL,133,134,2),(83,'skill','show',19,NULL,135,136,2),(84,'skill','show',20,NULL,137,138,2),(85,'skill','show',21,NULL,139,140,2),(86,'skill','show',22,NULL,141,142,2),(87,'skill','show',23,NULL,143,144,2),(88,'skill','show',24,NULL,145,146,2),(89,'skill','show',25,NULL,147,148,2);
...
INSERT INTO `dm_page_view` VALUES (1,'main','root',2),(2,'main','error404',1),(3,'main','signin',1),(4,'dmTag','list',1),(5,'article','list',1),(6,'article','show',3),(7,'dmTag','show',1),(8,'main','zazabe',1),(9,'main','cursus',1),(10,'main','projects',1),(11,'main','about',1),(12,'main','cursusPrint',4),(13,'main','cursusDownload',4),(14,'skill','list',1),(15,'skill','show',1);
...
INSERT INTO `dm_remember_key` VALUES (1,'67a02404f95e5350b8d97dd35772136f','127.0.0.1','2010-09-14 11:56:52');
...
INSERT INTO `dm_user` VALUES (1,'admin','admin@zazabe.com','sha1','d0a6b3733f4def2c25219f8e6b00240e','64348815e4f91c5b5e775d11aafd564201e187f3',1,1,'2010-09-14 16:03:01',NULL,'2010-08-27 15:19:29','2010-08-27 15:19:29');
...
INSERT INTO `dm_widget` VALUES (1,1,'dmWidgetContent','title',NULL,-1,'2010-08-27 15:19:33'),(2,2,'dmUser','signin',NULL,-2,'2010-08-27 15:19:33'),(4,10,'article','list','',1,'2010-08-27 15:44:27'),(7,6,'dmTag','popular','',1,'2010-08-27 15:46:54'),(8,11,'dmWidgetContent','title','',1,'2010-08-27 15:53:56'),(9,12,'dmWidgetNavigation','menu','',-3,'2010-08-27 15:58:01'),(11,13,'main','footer','',1,'2010-08-27 16:10:55'),(13,14,'dmTag','popular','',4,'2010-08-31 15:15:49'),(16,14,'dmWidgetContent','image','',1,'2010-08-31 15:15:17'),(17,14,'dmWidgetContent','text','left-content',2,'2010-08-31 15:18:58'),(18,17,'article','listByTag','',1,'2010-08-27 17:49:28'),(20,14,'dmWidgetContent','title','',3,'2010-08-31 15:15:49'),(23,4,'article','listAsBox','',2,'2010-08-31 15:44:14'),(24,3,'dmWidgetNavigation','menu','',1,'2010-09-02 15:21:39'),(25,20,'article','show','',1,'2010-09-03 17:57:23'),(26,21,'dmWidgetNavigation','menu','',1,'2010-09-07 11:18:16'),(29,7,'article','listCursus','',5,'2010-09-13 15:13:30'),(31,23,'article','listCursus','',4,'2010-09-13 15:17:08'),(32,24,'dmWidgetContent','link','icon back',1,'2010-09-11 10:06:50'),(34,25,'dmWidgetContent','link','icon print',2,'2010-09-11 10:06:36'),(35,25,'dmWidgetContent','link','icon download',1,'2010-09-11 10:06:29'),(36,23,'dmWidgetContent','link','icon back',1,'2010-09-11 10:07:44'),(37,7,'skill','list','',3,'2010-09-13 15:13:02'),(38,23,'skill','list','',6,'2010-09-13 15:17:08'),(39,7,'dmWidgetContent','title','',1,'2010-09-13 15:12:00'),(40,7,'dmWidgetContent','title','',2,'2010-09-13 15:13:13'),(41,7,'dmWidgetContent','title','clearfix',4,'2010-09-13 15:14:04'),(42,23,'dmWidgetContent','title','',5,'2010-09-13 15:17:08'),(43,23,'dmWidgetContent','title','',3,'2010-09-13 15:17:08'),(44,23,'dmWidgetContent','text','contact',2,'2010-09-13 16:21:07');
...
INSERT INTO `skill` VALUES (1,1,-1,1,1,14,0),(2,2,-2,1,2,3,1),(3,3,-3,1,4,5,1),(4,4,-4,1,6,7,1),(5,5,-5,1,8,9,1),(6,1,-6,1,10,11,1),(7,1,-7,1,12,13,1),(8,1,-8,8,1,20,0),(9,5,-9,8,2,9,1),(10,4,-10,8,7,8,2),(11,5,-11,8,3,4,2),(12,3,-12,8,10,11,1),(13,4,-13,8,12,19,1),(14,4,-14,8,13,14,2),(15,3,-15,8,15,16,2),(16,3,-16,8,17,18,2),(17,3,-17,8,5,6,2),(18,4,-18,18,1,8,0),(19,4,-19,18,2,3,1),(20,4,-20,18,4,5,1),(21,3,-21,18,6,7,1),(22,3,-22,22,1,8,0),(23,5,-23,22,2,3,1),(24,3,-24,22,4,5,1),(25,3,-25,22,6,7,1);
/*!40000 ALTER TABLE `skill` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `skill_translation`
--

DROP TABLE IF EXISTS `skill_translation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `skill_translation` (
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`,`lang`),
  CONSTRAINT `skill_translation_id_skill_id` FOREIGN KEY (`id`) REFERENCES `skill` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `skill_translation`
--

LOCK TABLES `skill_translation` WRITE;
/*!40000 ALTER TABLE `skill_translation` DISABLE KEYS */;
INSERT INTO `skill_translation` VALUES (1,'Design','fr','2010-09-12 17:03:14','2010-09-12 17:03:14'),(2,'Photoshop','fr','2010-09-12 17:03:40','2010-09-12 17:03:40'),(3,'Illustrator','fr','2010-09-12 17:04:07','2010-09-12 17:04:07'),(4,'InDesign','fr','2010-09-12 17:04:25','2010-09-12 17:04:25'),(5,'Gimp','fr','2010-09-12 17:04:39','2010-09-12 17:04:39'),(6,'Flash','fr','2010-09-12 17:04:52','2010-09-12 17:04:52'),(7,'3D Studio','fr','2010-09-12 17:05:11','2010-09-12 17:05:11'),(8,'Developement','fr','2010-09-12 17:05:42','2010-09-12 17:05:42'),(9,'PHP5 ','fr','2010-09-12 17:05:57','2010-09-12 17:05:57'),(10,'Symfony 1.4','fr','2010-09-12 17:06:27','2010-09-12 17:06:27'),(11,'Symfony 1.0','fr','2010-09-12 17:06:49','2010-09-12 17:06:49'),(12,'C/C++','fr','2010-09-12 17:07:07','2010-09-12 17:07:07'),(13,'Javascript','fr','2010-09-12 17:07:25','2010-09-12 17:07:25'),(14,'jQuery','fr','2010-09-12 17:08:19','2010-09-12 17:08:19'),(15,'mootools','fr','2010-09-12 17:08:32','2010-09-12 17:08:32'),(16,'prototype','fr','2010-09-12 17:08:51','2010-09-12 17:08:51'),(17,'Code Igniter','fr','2010-09-12 17:09:07','2010-09-12 17:09:07'),(18,'CMS','fr','2010-09-12 17:09:19','2010-09-12 17:09:19'),(19,'Joomla','fr','2010-09-12 17:09:40','2010-09-12 17:09:40'),(20,'Wordpress','fr','2010-09-12 17:09:54','2010-09-12 17:09:54'),(21,'Drupal','fr','2010-09-12 17:10:12','2010-09-12 17:10:12'),(22,'Project Management','fr','2010-09-12 17:10:32','2010-09-12 17:10:32'),(23,'SVN','fr','2010-09-12 17:11:07','2010-09-12 17:11:07'),(24,'Gitt','fr','2010-09-12 17:11:26','2010-09-12 17:11:26'),(25,'Hudson (continous integration)','fr','2010-09-12 17:11:55','2010-09-12 17:11:55');
/*!40000 ALTER TABLE `skill_translation` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2010-09-14 17:28:26
